...
<header class="w-full fixed top-0 bg-white z-50">
    <nav class="container flex justify-between py-5 items-center">
        ...
        <li class="relative h-full flex items-center group">
            ...
            <div class="hidden peer-hover:block hover:block group-hover:block absolute rounded-xl overflow-hidden top-full w-fit shadow-xl bg-white z-50">
            <div class="pt-12">
                <ul class="bg-white list-none text-nowrap pl-8 p-3 rounded-xl">
                    <li>
                        <a href="{{ route('sejarah') }}" class="w-full block pl-2 pr-8 py-1 lg:pl-0">
                            Sejarah
                        </a>
                    </li>
                    <li>
        ...
        <li class="relative h-full flex items-center group">
            ...
            <div class="pt-12">
                ...
                <div class="px-4 flex-1">
                    ...
                    >S1 REKAYASA PERANGKAT LUNAK</span
                    >
                    <ul class="list-none space-y-1 text-nowrap">
                    <li>
                ...
                <div class="px-4 flex-1">
                    ...
                    >
                    <ul class="text-nowrap space-y-1 list-none">
                    <li>
                        <a href="#" class="w-full block pl-2 pr-8 py-1"
